...
START_TEXT = "This is a Database Collection of Ching Yoshi Royotsu"

HELP_TEXT = ""
ABOUT_TEXT = "Created By Ching Yoshi Royotsu"
...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_text(
            ...
            parse_mode="HTML",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("DLU : ", url=stream_link)]])
        )
